function [err] = localNoisyBPSimAnneal(s,NumLayers, epsilon0, finalFracNoise, gradStep, Tavg, numIter)
...
for cnt=1:numIter
    [cnt,numIter]
    epsilon = epsilon0*(1 - (cnt/numIter)*(1-finalFracNoise));
    epsilon
